...
const scoreField = document.querySelector('#score_count');
var count = 0;
let alienInterval;
...
function gameOver(){
    ...
    setTimeout(() =>{
        alert('game over ! '+ 'sua pontuação foi de '+ count+' pontos');
